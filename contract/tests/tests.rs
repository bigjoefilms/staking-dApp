...
//                     "staking_contract.receive".to_string(),
//                 ),
...
//     let error: Cus = update.parse_return_value().expect("Deserialize `Error`");
...
//                 init_name: OwnedContractName::new_unchecked("init_staking_contract".to_string()),
